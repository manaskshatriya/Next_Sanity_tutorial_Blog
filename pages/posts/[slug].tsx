  ...
  return (
    <div>
      ...
      <img
        ...
        alt=""
      ></img>
      <article className="max-w-3xl  p-4  mx-auto ">
      ...
      {submitted ? (
        <div className="flex flex-col p-10 m-10 bg-yellow-500 text-white mx-auto max-w-xl" >
          <h1 className="text-3xl font-bold" >Thank you for Submitting your comment!</h1>
          <p>Once it is approvved it will appear below</p>
        </div>
      ) : (
        <form
          onSubmit={handleSubmit(onsubmit)}
          action=""
          className="flex flex-col p-5 max-w-lg  mb-10 mx-auto"
        >
        ...
        font-bold rounded cursor-pointer py-2 px-4"
          ></input>
        </form>
      )}
